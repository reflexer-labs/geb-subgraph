...
export let EnglishAuctionType_STAKED_TOKEN = 'STAKED_TOKEN'
...
export let AuctionToken_PROTOCOL_TOKEN_LP = 'PROTOCOL_TOKEN_LP'

export let EnglishBidType_INCREASE_BUY = 'INCREASE_BUY'
export let EnglishBidType_DECREASE_SOLD = 'DECREASE_SOLD'
