...
const gebVersion = process.argv[3] || 'kovan/1.1.0'
...
async function main() {
    ...
    for (let f of files) {
        const url = `https://raw.githubusercontent.com/reflexer-labs/geb-changelog/master/releases/${gebVersion}/median/abi/${f.slice(
            0,
            -5
        )}.abi`
